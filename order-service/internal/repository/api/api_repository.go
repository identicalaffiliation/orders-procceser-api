...
func NewAPIRepository(d *storage.Postgres, l logger.Logger) *apiRepository {
	return &apiRepository{db: d, itemsRepository: newItemsRepository(d, l), ordersRepository: newOrdersRepository(d, l), logger: l}
}
